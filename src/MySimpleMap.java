import utils.DefaultNotSupportedMap;
import utils.DefaultNotSupportedSet;
...
public class MySimpleMap<K, V> implements DefaultNotSupportedMap<K, V> {
    ...
    public MySimpleMap(int capacity) {
